...
class AdjustmentController extends AbstractController
{
                          ...
                          Request $request): Response
    {
        ...
        $model['adjustments'] = $adjustmentRepository
            ->findAdjustmentByPeriod($model['start'],$model['end'],$this->store);
     ...
     * @return Response
     */
    public function detail(Adjustment $adjustment): Response
    {
     ...
     * @throws Exception
     */
    public function print(Adjustment $adjustment, Pdf $pdf): Response
    {
