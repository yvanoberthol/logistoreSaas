...
class SettingController extends AbstractController
{
     ...
     * @return Response
     */
    public function index(AddonsRepository $addonsRepository,
                          ThemeRepository $themeRepository,
                          PageSizeRepository $pageSizeRepository): Response
    {

        $model['setting'] = $this->setting;
        $model['pageSizes'] = $pageSizeRepository->findBy(['store' => $this->store ]);
        $model['addons'] = $addonsRepository->findBy(['store' => $this->store ]);
        $model['themes'] = $themeRepository->findBy(['store' => $this->store ]);

        $model['pdfSaleFormat'] = $pageSizeRepository
            ->findOneBy(['height' => $model['setting']->getSaleReceiptHeight(),
                'width' => $model['setting']->getSaleReceiptWidth(),'store' => $this->store]);

        $model['pdfReportFormat'] = $pageSizeRepository
            ->findOneBy(['height' => $model['setting']->getReportHeight(),
                'width' => $model['setting']->getReportWidth(),'store' => $this->store]);
