...
class ProductRepository extends ServiceEntityRepository
{
    ...
    public function getWithBarCode($store=null): array
    {
        $qb = $this->createQueryBuilder('p')
            ->where('p.qrCode is not null');
        if ($store !== null){
            $qb->innerJoin('p.store','st')
                ->andWhere('st = :store')
    ...
    public function getBegin(string $name,$store=null): array
    {
        $qb = $this->createQueryBuilder('p')
    ...
    public function getByNameAndCategory($name,$category,$store=null): ?Product
    {
        try {
            $qb = $this->createQueryBuilder('p')
                ->select('p')
    ...
    public function saleByPeriodDate($start,$end,$user=null,$store=null): array
    {
        $qb = $this->createQueryBuilder('p')
    ...
    public function saleByCustomer($customer,$start=null,$end=null,$store=null): array
    {
        $qb = $this->createQueryBuilder('p')
            ->select('p', 'SUM(psa.qty) as qtySold',
                'sum(psa.subtotal) as amount')
    ...
    public function stockBySupplier($supplier,$start=null,$end=null,$store=null): array
    {
        $qb = $this->createQueryBuilder('p')
    ...
    public function getByPeriodDate($start,$end,$user=null,$customer=null,
                                    $category=null,$store=null): array
    {
        $qb = $this->createQueryBuilder('p')
            ->select('p', 'SUM(psa.qty) as qtySold',
    ...
    public function getByAdjustmentPeriodDate($start,$end,$user=null,
                                              $category=null,$store=null): array
    {
        $qb = $this->createQueryBuilder('p')
    ...
    public function getStockByPeriodDate($start,$end,$user=null,$supplier=null,
                                         $category=null,$store=null): array
    {
        $qb = $this->createQueryBuilder('p')
    ...
    public function saleByproduct($month, $year, $store=null): array
    {
        $qb = $this->createQueryBuilder('p')
            ->select('p', 'SUM(psa.qty) as qtySold',
                'SUM(psa.subtotal) as amount')
    ...
    public function getNew($interval,$store=null): array
    {
        $timestampDayExpiration = $interval * 24 * 3600;

        $qb = $this->createQueryBuilder('p')
            ->where('(TIMESTAMP(DATE(p.addDate))+:interval) <= TIMESTAMP(DATE(:end))')
    ...
    public function getSaleReturnByPeriodDate($start,$end,$store=null)
    {
        $qb = $this->createQueryBuilder('p')
    ...
    public function getSaleReturnStockableByPeriodDate($start,$end,$store=null)
    {
        $qb = $this->createQueryBuilder('p')
    ...
    public function getSaleReturnRepayByPeriodDate($start,$end,$store=null)
    {
        $qb = $this->createQueryBuilder('p')
    ...
    public function getStockReturnByPeriodDate($start,$end,$store=null)
    {
        $qb = $this->createQueryBuilder('p')
            ->select('p', 'SUM(psr.qty) as qtyReturn',
    ...
    public function getStockReturnRepayByPeriodDate($start,$end,$store=null)
    {
        $qb = $this->createQueryBuilder('p')
