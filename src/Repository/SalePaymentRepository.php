...
class SalePaymentRepository extends ServiceEntityRepository
{
    ...
    public function findByPeriodDate($start,$end,$sale=null,$customer=null,$store=null): array
    {
    ...
    public function groupByPeriodDate($start,$end,$sale=null,$customer=null,$store=null): array
    {
        $qb = $this->createQueryBuilder('sp')
    ...
    public function lastTenPayments($customer=null,$store=null): array
    {
        $qb = $this->createQueryBuilder('sp')
            ->select('DATE(sp.addDate) as date','SUM(sp.amount) as amount',
                'c.id as customerId','c.name as customerName','r.name as recorderName')
