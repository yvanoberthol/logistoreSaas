...
class StockPaymentRepository extends ServiceEntityRepository
{
    ...
    public function findStockPaymentByPeriod($start,$end,$stock=null,$supplier=null,$store=null): ?array
    {
    ...
    public function groupByPeriodDate($start,$end,$stock=null,$supplier=null,$store=null): array
    {
        $qb = $this->createQueryBuilder('sp')
    ...
    public function lastTenPayments($supplier=null,$store=null): array
    {
        $qb = $this->createQueryBuilder('sp')
            ->select('DATE(sp.addDate) as date','SUM(sp.amount) as amount',
                'su.id as supplierId','su.name as supplierName','r.name as recorderName')
